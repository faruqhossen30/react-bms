...
const Footer = () => {
    ...
    return (
        <footer className='md:hidden grid grid-cols-5 border-t-2 text-sm text-purple-800 bg-red-100 inset-x-0 bottom-0 fixed pt-4'>
                                    ...
                                    auth() && auth().username
                                        ? (
                                            <>
                                                ...
                                                <button className='flex items-center space-x-2 p-2' onClick={()=>signOut()}>
                                                    <FaMoneyBillAlt />
                                                    <span>Logout</span>
                                                </button>
                                            </>
